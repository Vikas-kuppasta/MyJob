...
const ForCompanies = () => {
  return (
   <>
    <main className='flex max-sm:flex-col  lg:h-screen lg:items-center'>
        {/* image */}
        <div className='max-md:py-5 px-5 py-10 md:w-1/2  lg:h-150'>
            <img src={recruiter} alt="" />
        </div>
        {/* description */}
        <div className='md:w-1/2 max-md:py-5 px-5 py-10 xl:h-150 flex flex-col gap-5'>
